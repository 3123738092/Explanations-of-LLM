...
Uses ``src.explain.attnlrp_gpt2_efficient.explain_sample`` and ``load_gpt2_efficient_with_attnlrp`` (efficient Input*Gradient / monkey_patch path), plus ``src.visualize.relevance_plots``.
...
from src.visualize.relevance_plots import save_layer_heatmap, save_token_heatmap
